...
const Inicio = () => {
    return (
        <div className='fondoInicio text-center'>
            ...
            <p className="text-center container py-2">Nuestra tecnología permite que la deteccion de cancer sea más rápida y precisa. El futuro de la pathologia es ahora. <br />El futuro es GigPatho</p>
